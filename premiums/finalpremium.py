...
xls = pd.ExcelFile("/Users/mkeyakalaneema/Desktop/sqlpractice/shortterm/premiums/2023lt.xlsx")
        ...
        if company_id is not None:
            ...
            for claim_type, premium_value in row.iloc[1:].items():
                ...
                if claim_type_id is not None:
                    ...
                    cursor.execute("INSERT INTO premiums (company_id, claim_type_id, premium_value, year, quarter_name, duration) VALUES (%s, %s, %s, %s, %s,%s)",
                                   (company_id, claim_type_id, premium_value, 2023, sheet_name,'LT'))
